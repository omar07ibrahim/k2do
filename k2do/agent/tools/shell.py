...
class ExecTool(Tool):
    ...
    async def execute(self, command: str, working_dir: str | None = None, **kwargs: Any) -> str:
        cwd = Path(working_dir or self.working_dir or os.getcwd()).resolve()
        if self.restrict_to_workspace and self.workspace_root:
    ...
    def _guard_command(self, command: str, cwd: str) -> str | None:
        ...
        if self.restrict_to_workspace:
            ...
            workspace_root = self.workspace_root or cwd_path
